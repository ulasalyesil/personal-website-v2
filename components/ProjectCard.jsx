...
function ProductCard({ target, icon, title, img }) {
  return (
    ...
    >
      ...
      />
      <div className="absolute bottom-0 left-0 w-full h-full bg-gradient-to-t backdrop-blur-sm group-hover:backdrop-blur-none from-neutral-100 dark:from-neutral-900 to-neutral-900/5 -z-10 overflow-hidden md:hover:scale-105 transition ease-in-out delay-50"></div>
