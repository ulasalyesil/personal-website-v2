...
export default function ProjectCard({ title, description, img, target }) {
  return (
    <Link
      href={target}
      className="group relative w-full flex flex-col gap-2 p-4 bg-neutral-50 dark:bg-neutral-900/50 border border-neutral-200 dark:border-neutral-800 rounded-md transition ease-in-out duration-300 hover:shadow-xl hover:scale-[1.02]"
    >
