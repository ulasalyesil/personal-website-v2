...
function HProjectCard({
  ...
  return (
    <Link
      href={target}
      className="relative group flex gap-4 h-40 sm:h-56 overflow-hidden p-4 rounded-3xl bg-gradient-to-b from-white to-neutral-100 dark:bg-gradient-to-b dark:from-neutral-900 dark:to-neutral-950  border border-neutral-200 dark:border-neutral-800 shadow-md transition ease-in-out delay-50 md:hover:shadow-xl md:hover:scale-105"
    >
