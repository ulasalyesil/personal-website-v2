        ...
        />
          ...
          className="flex flex-col gap-4 items-center">
            ...
            <p className={styles.p}>
              ...
              Jotform, I contributed to a significant project aimed at designing
              a seamless integration with QuickBooks, a widely used accounting
              software. This case study explores the user-centric design process
              that drove the development of this integration and improved
              Jotform&apos;s overall integrations experience.
            </p>
            ...
            <p className={styles.p}>
              ...
              team and overlook the whole design process. Based on the research
              findings and personas, I designed user flows, journey maps, and
              new components that aligned with our design system.
            </p>

            <h2 className={styles.h2}>Understanding User Needs</h2>
            <p className={styles.p}>
              To effectively meet our users&apos; needs, we conducted extensive
              user interviews and surveys. This provided valuable insights into
              our users&apos; pain points and requirements, both qualitatively
              and quantitatively.
            </p>
            ...
            <p className={styles.p}>
              Through user studies, we identified some challenges. For example,
              QuickBooks required exact product names for invoicing, which might
              not align with Jotform&apos;s product names. Additionally, not all
              users were utilizing the &quot;Product List&quot; form field,
              affecting the ideal integration scenario.
            </p>
            <p className={styles.p}>
            ...
            <ol className="list-decimal list-inside mt-2">
              <li className={styles.p}>
                ...
                suggestion mechanism during the integration setup, automatically
                recommending similar product names based on user input. This
                reduced discrepancies and potential errors in product name
                matching.
              </li>
              <li className={styles.p}>
              ...
              <li className={styles.p}>
                ...
                promote the benefits of the &quot;Product List&quot; form field,
                encouraging users to explore its potential and enhance their
                integration experience.
              </li>
              <li className={styles.p}>
                Clear Communication: Throughout the design process, we
                maintained transparent communication with users, informing them
                of updates, improvements, and new features in the QuickBooks
                integration. We actively encouraged feedback channels for
            ...
            <p className={styles.p}>
              ...
              project, we fostered collaboration among different teams,
              unlocking new possibilities for both the integration and other
              Jotform products.
            </p>
            <ul className="list-disc list-inside mt-2">
              ...
              <li className={styles.p}>
                ...
                Approvals allowed users to automate approval processes based on
                accounting data, streamlining business workflows and saving
                time.
              </li>
            </ul>
            ...
            <p className={styles.p}>
              ...
              an integration that simplifies accounting workflows for our users.
              Collaborating with different teams unlocked new possibilities,
              providing users with enhanced value across various Jotform
              products. We remain dedicated to refining the integration based on
              user feedback, ensuring that Jotform continues to empower users in
              their professional journeys. The challenges we encountered were
              met with innovative solutions, further solidifying Jotform&apos;s
